...
export default function Home() {
  ...
  return (
    <div>
      <Header />
      <main className="h-screen relative flex justify-center items-center flex-col">
        <h2 className="text-xl text-gray-600 dark:text-gray-200">
          {t("greetings")}
        </h2>
        <h1 className="text-5xl text-gray-700 dark:text-gray-50">
          {t("title")}
        </h1>
      ...
      <section className="min-h-screen flex justify-center pt-44">
      ...
      <section className="min-h-screen flex flex-col items-center pt-20">
        ...
        <div className="container max-w-5xl mx-auto w-full h-full pt-20">
          <div className="relative wrap overflow-hidden p-10 h-full">
            <div className="border-2-2 absolute border-opacity-20 border-gray-700 dark:border-white/30 h-full border left-2/4"></div>
            <div className="mb-8 flex justify-between items-center w-full right-timeline">
              ...
              <div className="order-1 dark:bg-neutral-900/80 dark:text-gray-300 dark:border-gray-800 bg-white/70 text-gray-800 border backdrop-blur-lg drop-shadow-md rounded-lg shadow-xl w-5/12 px-6 py-4">
            ...
            <div className="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline text-neutral-800">
              ...
              <div className="order-1 dark:bg-neutral-900/80 dark:text-gray-300 dark:border-gray-800 bg-white/70 text-gray-800 border backdrop-blur-lg drop-shadow-md rounded-lg shadow-xl w-5/12 px-6 py-4 relative">
      ...
      <section className="min-h-screen pt-36 flex justify-center items-center flex-col pb-40">
        ...
        <div className="flex justify-center gap-20 mt-20">
          ...
          {/* <div className="w-64 h-72 bg-gray-300 rounded-xl"></div> */}
          <p className="max-w-2xl whitespace-pre-line mt-2 text-gray-600 dark:text-gray-300 font-medium text-lg">
            {TAboutMe("description")}
          </p>
        </div>
      </section>

      <section className="h-screen pt-20 flex items-center gap-20 flex-col relative">
        <div className="flex flex-col text-center">
          <h1 className="text-5xl font-semibold text-gray-700 dark:text-gray-200">
            {TContact("title")}
          </h1>
