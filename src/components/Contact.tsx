...
export const Contact = ({ title, button }: ContactProps) => {
  return (
    ...
    >
      ...
      >
        <Link
          href="mailto:filipe.dev34@hotmail.com"
          className="items-center justify-center flex cursor-pointer px-16  bg-gray-300 dark:bg-gray-600 font-medium text-gray-800 dark:text-gray-300 h-12 rounded-lg"
        >
          {button}
        </Link>
